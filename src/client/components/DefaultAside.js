...
class DefaultAside extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment className="background-white">
        <Nav tabs>
          <NavItem>
            ...
            <ListGroup className="list-group-accent">
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-warning list-group-item-divider">
                <div className="avatar float-right">
                  <img className="img-avatar" src={require('../assets/img/avatars/7.jpg')} alt="admin@bootstrapmaster.com"></img>
                </div>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-info list-group-item-divider">
                <div className="avatar float-right">
                  <img className="img-avatar" src={require('../assets/img/avatars/4.jpg')} alt="admin@bootstrapmaster.com"></img>
                </div>
              ...
              <ListGroupItem action tag="a" href="#" className="list-group-item-accent-primary list-group-item-divider">
                ...
                <div className="avatars-stack mt-2">
                  ...
                  <div className="avatar avatar-xs">
                    <img src={require('../assets/img/avatars/7.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                  <div className="avatar avatar-xs">
                    <img src={require('../assets/img/avatars/8.jpg')} className="img-avatar" alt="admin@bootstrapmaster.com" />
                  </div>
                </div>
              </ListGroupItem>
            </ListGroup>
